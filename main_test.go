...
func TestBuildMDNSBPFFilter(t *testing.T) {
	...
	want := "not (ether src 00:11:22:33:44:55) and udp dst port 5353"
	if got != want {
...
func TestBuildMDNSBPFFilterExcludesAllLocalMACs(t *testing.T) {
	...
	want := "not (ether src 00:11:22:33:44:55 or ether src aa:bb:cc:dd:ee:ff) and udp dst port 5353"
	if got != want {
		t.Errorf("buildMDNSBPFFilter() = %q, want %q", got, want)
	}
}
...
func TestBuildMDNSBPFFilterRequiresVLAN(t *testing.T) {
	...
	want := "not (ether src 00:11:22:33:44:55) and vlan and udp dst port 5353"
	if got != want {
		t.Errorf("buildMDNSBPFFilter() = %q, want %q", got, want)
	}
}
